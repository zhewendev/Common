package com.baiheng.common.network.cookie.store;
 ...
 * <p/>
 * <br/>
 * A persistent cookie store which implements the Apache HttpClient CookieStore interface. Cookies
 * are stored and will persist on the user's device between application sessions since they are
 * serialized and stored in SharedPreferences. Instances of this class are designed to be used with
 * AsyncHttpClient#setCookieStore, but can also be used with a regular old apache
